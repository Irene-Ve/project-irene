/*
The only purpose of this class is to facilitate the insertion of ALL
the colors' shades in every Tailwind's class that needs them.
But how ?
ctrl+f  --->  insert the actual first word present on the file (ie: text-...)
--->  select alla occurencies + digit the new word  --->  voilà!
*/
